...
export const RESOURCE_CONFIG = {
  products: {
    ...
    fields: [
      ...
      { name: "brochure_url", label: "Brochure / datasheet (PDF)", type: "file", group: "Media" },
      {
        name: "datasheet_access",
        label: "Datasheet access",
        type: "select",
        group: "Media",
        options: [
          { label: "Public — downloads directly", value: "public" },
          { label: "Private — email + OTP verification", value: "gated" },
        ],
        help: "Private datasheets require the visitor to verify their email with a one-time code before downloading.",
      },
